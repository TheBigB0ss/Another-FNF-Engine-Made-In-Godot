...
func _ready() -> void:
	...
	if Global.is_playing:
		if song == "stress":
			var jsonFile = FileAccess.open("res://assets/data/stress/picospeaker.json", FileAccess.READ);
...
func _process(delta):
	...
	if !Global.is_playing or song != "stress":
		return;
...
func ugh_cutscene():
	...
	SoundStuff.playAudio("week7_cutscene_voices/wellWellWell", false);
	...
	SoundStuff.playAudio("week7_cutscene_voices/bfBeep", false);
	
	await get_tree().create_timer(0.8).timeout
	bf_anim._playAnim("idle dance");
	camera.position = Vector2(280, 698);
	tankmanCutscene.anim_to_play.play("TANK TALK 1 P2/ ");
	SoundStuff.playAudio("week7_cutscene_voices/killYou", false);
...
func guns_intro():
	...
	SoundStuff.playAudio("week7_cutscene_voices/tankSong2", false);
...
func stress_intro():
	...
	SoundStuff.playAudio("week7_cutscene_voices/stressCutscene", false);
